...
namespace TPBank.BusinessLogicLayer
{
	...
	{
		/// <summary>
		/// Check whether a saved customer information match either phone number or username as the about to be added customer information
		/// </summary>
		/// <param name="customer">The customer information to check</param>
		/// <returns>Null or the existed customer information</returns>
